...
export const styles = StyleSheet.create({
  ...
  methodTrack: { marginBottom: spacing.lg },
  ...
  mobilePrefixText: { ...typography.bodyLg, color: colors.inkSoft },
  mobileNotice: { ...typography.caption, color: colors.inkFaint, marginTop: -spacing.sm, marginBottom: spacing.md },
